...
export default function ForecastCharts({ latitude, longitude }: ForecastChartsProps) {
  ...
  const fetchDetailedForecast = async () => {
    ...
    try {
      // Mock detailed forecast data for static export
      const mockData: DetailedForecast = {
        location: {
          latitude,
          longitude
        },
        hourlyForecast: [
          { time: '18:00', kpIndex: 3.2, cloudCover: 15, temperature: -3, windSpeed: 8, auroraScore: 65, visibility: 'Good' },
          { time: '19:00', kpIndex: 3.5, cloudCover: 20, temperature: -4, windSpeed: 10, auroraScore: 70, visibility: 'Good' },
          { time: '20:00', kpIndex: 3.8, cloudCover: 25, temperature: -5, windSpeed: 12, auroraScore: 75, visibility: 'Good' },
          { time: '21:00', kpIndex: 4.1, cloudCover: 30, temperature: -6, windSpeed: 15, auroraScore: 80, visibility: 'Fair' },
          { time: '22:00', kpIndex: 4.5, cloudCover: 20, temperature: -6, windSpeed: 18, auroraScore: 85, visibility: 'Good' },
          { time: '23:00', kpIndex: 4.8, cloudCover: 15, temperature: -7, windSpeed: 20, auroraScore: 90, visibility: 'Excellent' },
          { time: '00:00', kpIndex: 4.2, cloudCover: 10, temperature: -8, windSpeed: 16, auroraScore: 88, visibility: 'Excellent' },
          { time: '01:00', kpIndex: 3.9, cloudCover: 25, temperature: -8, windSpeed: 14, auroraScore: 82, visibility: 'Good' }
        ],
        summary: {
          bestHours: ['22:00', '23:00', '00:00'],
          averageScore: 79,
          peakActivity: '23:00'
        }
      }
